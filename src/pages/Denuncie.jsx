...
const Denuncie = () => {
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-off-white pb-20 pt-32">
            <div className="max-w-4xl mx-auto px-6">
                <PageHeader
                    title="Canal de Denúncias"
                    description="Ajude a preservar o Parque Estadual Cunhambebe. Garantimos sigilo absoluto."
                />

                {/* Form Card */}
                <div ref={formRef} className="bg-white p-6 md:p-10 rounded-xl shadow-lg border border-earth/10 anim-form mb-12 relative z-30">
